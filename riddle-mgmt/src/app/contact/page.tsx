  ...
  return (
    ...
    <div className="min-h-screen flex flex-col items-center justify-center sm:justify-start pt-0 sm:pt-32 pb-20 px-5 sm:px-8">
      <div className="max-w-md w-full text-center sm:text-left">
        ...
        <div className="w-8 h-px bg-white/10 mt-4 mb-10 animate-fade-in delay-100 mx-auto sm:mx-0" />

        <p className="text-sm text-white/40 font-light mb-10 animate-fade-in delay-200">
        ...
        <div className="animate-fade-in delay-300">
          ...
          <a
            ...
            className="text-sm text-white/50 hover:text-white transition-colors duration-300 font-light mt-2 inline-block"
          >
            team@riddlellc.biz
          </a>
        </div>
